# Django settings for highlite project.
...
FIXTURE_DIRS = (os.path.join(ROOT_DIR, 'highlighter.fixtures'),)
...
MEDIA_ROOT = os.path.join(ROOT_DIR, 'db', 'images')
